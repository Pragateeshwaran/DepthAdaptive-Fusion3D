...
def get_calib(root_dir=ROOTDIR, split='train', from_idx=0, count=None):
    """
...
def find_label_files(root_dir=ROOTDIR, split="train"):
    """
...
def get_labels(root_dir=ROOTDIR, split='train', from_idx=0, count=None):
    """
