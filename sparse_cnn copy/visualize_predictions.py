...
CHECKPOINT_PATH = r'F:\Work\DeepLearning\Research\checkpoint_epoch_89.pth'  # Use the overfitted model
...
VIS_MATCH_PRED_TO_GT = True
VIS_MAX_PRED_GT_CENTER_DIST = 8.0  # meters
VIS_FALLBACK_TOPK = 12
VIS_CENTER_DEDUP_RADIUS_M = 1.5
